...
import 'dua_recitation_model.dart';
export 'dua_recitation_model.dart';
...
class _DuaRecitationWidgetState extends State<DuaRecitationWidget> {
  late DuaRecitationModel _model;
