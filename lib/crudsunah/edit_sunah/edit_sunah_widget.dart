...
import 'edit_sunah_model.dart';
export 'edit_sunah_model.dart';

class EditSunahWidget extends StatefulWidget {
  const EditSunahWidget({
    super.key,
    this.id,
    this.idkategori,
    this.judulDoa,
  ...
  @override
  State<EditSunahWidget> createState() => _EditSunahWidgetState();
}

class _EditSunahWidgetState extends State<EditSunahWidget> {
  late EditSunahModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditSunahModel());
    ...
    _model.textFielArabTextController ??=
        TextEditingController(text: widget.doabahasaarab);
