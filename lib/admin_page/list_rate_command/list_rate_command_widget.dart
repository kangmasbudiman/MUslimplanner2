...
import 'list_rate_command_model.dart';
export 'list_rate_command_model.dart';
...
class _ListRateCommandWidgetState extends State<ListRateCommandWidget> {
  late ListRateCommandModel _model;
          ...
          child: Padding(
            ...
            child: FutureBuilder<ApiCallResponse>(
              ...
              builder: (context, snapshot) {
                ...
                final columnGetCommandRateResponse = snapshot.data!;

                return Builder(
                  builder: (context) {
                    final item = GetCommandRateCall.data(
                          columnGetCommandRateResponse.jsonBody,
                        )?.toList() ??
                        [];
