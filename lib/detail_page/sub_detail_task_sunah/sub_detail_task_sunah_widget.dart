                                ...
                                children: [
                                  ...
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final listViewFadilahbysunahResponse =
                                          snapshot.data!;
                                                                    ...
                                                                    return WebViewAware(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              EditDoaCopyWidget(
                                                                            id: (SunahGroup.fadilahbysunahCall
                                                                                    .id(
                                                                                      listViewFadilahbysunahResponse.jsonBody,
                                                                                    )
                                                                                    ?.elementAtOrNull(resfadilahIndex))
                                                                                ?.toString(),
                                                                            fadilah: SunahGroup.fadilahbysunahCall
                                                                                .fadilah(
                                                                                  listViewFadilahbysunahResponse.jsonBody,
                                                                                )
                                                                                ?.elementAtOrNull(resfadilahIndex),
                                                                            pejelasan: SunahGroup.fadilahbysunahCall
                                                                                .penjelasan(
                                                                                  listViewFadilahbysunahResponse.jsonBody,
                                                                                )
                                                                                ?.elementAtOrNull(resfadilahIndex),
